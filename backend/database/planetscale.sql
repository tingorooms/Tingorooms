-- ============================================================
-- Room Rental & Expense Management System
-- Planetscale-Compatible Schema
-- ============================================================
-- IMPORTANT: Foreign key constraints are intentionally removed.
-- Planetscale uses Vitess which does NOT support FK enforcement.
-- All referential integrity is handled at the application layer.
-- Use this file for Planetscale. Use local.sql for standard MySQL.
-- ============================================================
...
CREATE TABLE users (
    ...
    contact_visibility ENUM('Private', 'Public') DEFAULT 'Private',
    gender ENUM('Male', 'Female', 'Other') NOT NULL,
    pincode VARCHAR(10) NOT NULL,
    city VARCHAR(100) NULL,
    password_hash VARCHAR(255) NOT NULL,
    role ENUM('Admin', 'Member', 'Broker') DEFAULT 'Member',
    broker_area VARCHAR(255) NULL,
    broker_status ENUM('Pending', 'Approved', 'Hold', 'Rejected', 'Suspended') DEFAULT NULL,
...
('Broker Monthly', 'BROKER_MONTHLY', 'Broker', 'Monthly broker subscription', 999.00, 30, '["Unlimited room postings", "Auto-approved listings", "Premium plan for all rooms", "Edit rooms anytime", "Featured listings", "Priority support", "Analytics dashboard"]'),
('Broker Quarterly', 'BROKER_QUARTERLY', 'Broker', 'Quarterly broker subscription', 2499.00, 90, '["Unlimited room postings", "Auto-approved listings", "Premium plan for all rooms", "Edit rooms anytime", "Featured listings", "Priority support", "Analytics dashboard", "10% savings"]'),
('Broker Yearly', 'BROKER_YEARLY', 'Broker', 'Yearly broker subscription', 8999.00, 365, '["Unlimited room postings", "Auto-approved listings", "Premium plan for all rooms", "Edit rooms anytime", "Featured listings", "Priority support", "Analytics dashboard", "25% savings", "Dedicated account manager"]');
